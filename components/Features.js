...
const Feature = () => {
  ...
  return (
<div class="bg-white py-6 sm:py-8 lg:py-12 my-6" id="feature">
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    {/* <!-- text - start --> */}
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-grey-800 md:mb-6 lg:text-4xl">Our competitive advantage</h2>

      <p class="mx-auto max-w-screen-md text-center text-grey-500 md:text-lg">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.</p>
    </div>
    {/* <!-- text - end --> */}
    ...
    <div class="grid gap-12 sm:grid-cols-2 xl:grid-cols-3 xl:gap-16">
      ...
      <div class="flex flex-col items-center">
        ...
        <p class="mb-2 text-center text-grey-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
