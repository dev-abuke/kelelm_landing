...
const Pricing = () => {
    ...
    return (
        <>
            <div class="flex flex-col items-center justify-center min-h-screen p-10 text-gray-700 bg-white-500 md:p-20">
                ...
                <div class="flex flex-wrap items-center justify-center w-full max-w-4xl mt-8">
                    ...
                    {/* <!-- Tile 2 --> */}
                    <div class="z-10 flex flex-col flex-grow mt-8 overflow-hidden transform bg-white-500 rounded-lg shadow-lg md:scale-110">
                        <div class="flex flex-col items-center p-10 bg-gray-200">
