module.exports = {
  ...
  theme: {
    boxShadow: {
      ...
      lg: "0 0px 25px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",
      xl: "0 20px 35px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
      t: "0 -1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",
      orange: "0px 20px 20px -15px rgba(26,80,181,0.2) ",
      "orange-md": "0px 20px 40px -15px rgba(26,80,181,0.3)",
      none: "none",
    },
    colors: {
